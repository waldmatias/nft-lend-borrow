...
describe("nft-lend-borrow", () => {
  ...
  it("Can initialize the state of the world", async () => {
    ...
    let [collectionPoolAddress, _collectionBump] = anchor.web3.PublicKey
  ...
  it("Can borrow loan", async () => {
    let [activeloan, _activeLoanBump] = anchor.web3.PublicKey
      .findProgramAddressSync(
        [
    ...
    let [vaultAsset, _vaultAssetBump] = anchor.web3.PublicKey
      .findProgramAddressSync(
        [
    ...
    let [vaultAuth, _vaultAuthBump] = anchor.web3.PublicKey
      .findProgramAddressSync(
        [collectionPoolPDA.toBuffer()],
        program.programId,
      );
    ...
    const minimumBalanceForRentExemption = await provider.connection
      .getMinimumBalanceForRentExemption(41);
    ...
    const minimumBalanceForRentExemptionForOfferAccount = await provider
